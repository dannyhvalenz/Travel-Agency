...
<body class="text-center">
    <header class="header">
        <div class="navbar p-3 px-md-4 mb-3 bg-white shadow-sm">
            <img src="assets/img/logo-letras.png" height="40">
            <nav class="cl-effect-3 my-2 my-md-0 mr-md-3">
                <a class="p-2 active" href="#" style="text-decoration:none;">Vuelos</a>
        ...
        <div class="carousel-inner" role="listbox" style=" width:100%; height: 500px !important;">
            ...
            <div class="carousel-inner" role="listbox">
                ...
                <div class="carousel-item active">
                    <img class="d-block w-100" src="assets/img/plane1.jpeg" alt="First slide">
                </div>
                <!--/First slide-->
                <!--Second slide-->
                <div class="carousel-item">
                    <img class="d-block w-100 img-fluid" src="assets/img/plane2.jpeg" alt="Second slide">
                </div>
                <!--/Second slide-->
                <!--Third slide-->
                <div class="carousel-item">
                    <img class="d-block w-100" src="assets/img/plane3.jpeg" alt="Third slide">
                </div>
                <!--/Third slide-->
            </div>
            <!--/.Slides-->
        ...
        <form action="hotelresuts.php" method="POST">
            ...
            <div class="row fixed-middle p-3" style="margin-top:100px;">
                <div class="form-group px-md-3"">
                    <label class="d-block text-white">Origen</label>
                    <select name="origen" class="d-block select-form" required>
                ...
                <div class="form-group px-md-3"">
                    <label class="d-block text-white">Destino</label>
                    <select name="destino" class="d-block select-form" required>
                        <option value="Mexico">Ciudad de México, México</option>
                        <option value="EEUU" selected>Nueva York, EE.UU.</option>
                        <option value="Canada">Toronto, Canadá</option>
                    </select>
                </div>
                <div class="form-group px-md-3">
                    <label class="text-white d-block">Salida</label>
                    <input name="check-in"
                        class="d-block input-format form-control" type="date" value="<?php echo date('yy-m-d'); ?>"
                        required>
                </div>
                <div class="form-group px-md-3">
                    <button style="margin-top:32px;height: 70px;  width:170px; border:none;" type="submit"
                        class="input-format btn btn-warning form-control">Buscar vuelo</button>
                </div>
            </div>
        </form>
    </div>
    <div class="container">
    <div class="container card-deck" style="float:right; right:-10vw;background-color:red; height:80vh; width:80vw">
